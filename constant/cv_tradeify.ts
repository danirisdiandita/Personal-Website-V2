...
export const CVDataTradeify: CVData = {
    personalInfo: {
    ...
    skills: [
        { category: "Backend & APIs", items: "REST, Django, FastAPI, Flask, Gin, NestJS, scalable microservices, WebSocket" },
        { category: "Cloud & Infra", items: "AWS, GCP, Kubernetes, Docker, Cloud Run, AWS Lambda" },
        { category: "Databases", items: "SQL, PostgreSQL, BigQuery, MongoDB" },
